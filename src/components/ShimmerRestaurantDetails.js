const ShimmerRestaurantDetails = () => {
  return (
    <>
      ...
      <div className="w-[1100px] h-[140px] rounded-lg border-4 border-slate-200 flex justify-between   mx-auto my-10  px-4 items-center">
      ...
      {/*  menu items */}
      <div className="w-[820px]   mx-auto my-32 flex flex-col gap-12   ">
        {/*  1st card */}
        <div className="w-full h-44   px-4 flex justify-between ">
          {/*  menu details name , price , cuisine etc */}
          <div className="flex flex-col gap-4 justify-center">
            <div className="h-6 w-56 bg-slate-200 animate-pulse"></div>
            <div className="h-6 w-20 bg-slate-200 animate-pulse"></div>
            <div className="h-6 w-20 bg-slate-200 animate-pulse"></div>
            <div className="h-6 w-[32rem] bg-slate-200 animate-pulse"></div>
          </div>
          {/*  menu image & btn */}
          <div>
            <div className="w-56 h-32 bg-slate-200 animate-pulse rounded-lg"></div>
